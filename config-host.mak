...
libs_softmmu=-lpixman-1  -lutil -lncurses -ltinfo    
ARCH=x86_64
CONFIG_DEBUG_TCG=y
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=2.6.50
PKGVERSION=
SRC_PATH=/home/src/linux-dmar/qemu/yan1
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/src/linux-dmar/qemu/yan1/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
